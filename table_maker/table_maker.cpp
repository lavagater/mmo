...
int main(int argc, char **argv)
{
  if (argc == 1)
  {
    ...
    std::cout << argv[0] << " table_name value1(num_bytes) type(0=char,1=int,2=Unsigned int, 3=short,4=float,5=double,6=string,7=blob) is_sorted(0,1) value2 type is_sorted value3 type is_sorted" << std::endl;
    return 1;
  }
